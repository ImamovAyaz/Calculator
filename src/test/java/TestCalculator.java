...
public class TestCalculator {
    ...
    @Test(groups = "negative", expectedExceptions = {ArithmeticException.class, InvalidParameterException.class})
    void divNegativeTest() {
        assertEquals(calculator.div(10, 0), 10 / 0, "Было вызвано исключение InvalidParameterException");
    }
